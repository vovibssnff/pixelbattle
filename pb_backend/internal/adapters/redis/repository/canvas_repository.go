...
// WritePixel writes a pixel to the canvas in Redis.
...
// CheckInitialized checks if the canvas is already initialized.
...
// LoadHeatMap retrieves the heatmap data for the canvas.
